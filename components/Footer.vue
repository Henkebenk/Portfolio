<template>
    <div class="p-4 w-full border-t border-(--ui-border) mt-32">
        <div
            class="w-full max-w-(--ui-container) mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-around"
        >
            <svg
                version="1.0"
                xmlns="http://www.w3.org/2000/svg"
                preserveAspectRatio="xMidYMid meet"
                viewBox="464 126.25 238.12 317.05"
                class="h-6"
            >
                <g
